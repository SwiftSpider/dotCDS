...
wn = turtle.Screen()
wn.title("Offline Dino")
wn.bgcolor("black")
wn.setup(height=320, width=800)
wn.bgpic("userfiles/Games/Images/dinobackground.gif")
wn.tracer(0)

wn.register_shape("userfiles/Games/Images/dino.gif")
wn.register_shape("userfiles/Games/Images/cactus.gif")
...
jumper.speed(0)
jumper.shape("userfiles/Games/Images/dino.gif")
jumper.color("green")
jumper.penup()
jumper.dy = 0
jumper.dx = 0
...
obstacle.speed(0)
obstacle.shape("userfiles/Games/Images/cactus.gif")
obstacle.color("red")
obstacle.penup()
obstacle.dx = -3
obstacle.height = 30
...
while True:
    ...
    elif(obstacle_right > jumper_left and obstacle_right < jumper_right and obstacle_top > jumper_bottom):
        print("GAME OVER")
        obstacle.goto(450, LINE_HEIGHT + obstacle.height/2)
        obstacle.dx = -3
        points = 0
