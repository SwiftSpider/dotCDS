...
wn.onkeypress(player_accelerate, "w")
wn.onkeypress(player_decelerate, "s")
wn.onkeypress(player_fire_phaser, "Shift_R")
wn.onkeypress(lightSpeed, "l")
wn.onkeypress(stopBullet, "f")
